...
class CalendarYvv{
	constructor(etiqueta="", diaSeleccionado="", primerDia="Lunes") {
		this.etiqueta = etiqueta; // etiqueta donde se mostrará id=""
		...
		this.__author = "Alejandro Valenzuela";
		this.__email = "tzalejo@gmail.com";
	...
	startElements(){
		...
		this.diasCoto = ["Dom","Lun","Mar","Mie","Jue","Vie","Sab"];
		//["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"];
		this.diasLargo = ["Domingo","Lunes","Martes","Miércoles","Jueves","Viernes","Sábado"];
	...
	createDaysMont(){
		...
		// console.log('diaSelected',diaSelected);
		var primerDiaMes = moment(diaSelected).format("dddd");
		// console.log('primerDiaMes',primerDiaMes);
		...
		// console.log('diasOrd',diasOrd);
		var posMes = diasOrd.fechLarg.indexOf(diaInicio);
		// console.log('diasOrd.fechLarg.indexOf(diaInicio)',diasOrd.fechLarg.indexOf(diaInicio));
