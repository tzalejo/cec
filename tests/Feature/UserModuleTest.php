...
class UserModuleTest extends TestCase
{
    ...
    public function test_no_autenticacion_del_usuario_con_credenciales_invalidas()
    {
        ...
        $this->post('api/auth/login', $credentials)->assertStatus(
    ...
    public function test_validacion_request_de_autenticacion()
    {
        ...
        return [
            ...
            'El password es requerido para la autenticacion' => [
                'password',
                null,
            ],
        ];
    ...
    public function test_valida_registro_de_un_usuario()
    {
        ...
        factory(Role::class)->create([
            'roleDescripcion' => Config::get('constants.USER'),
        ]);
        $user = [
        ...
        $this->post('api/auth/signup', $user)
            ...
            ->assertExactJson([
                'message' => 'Usuario Eliseo Nicolas creado satisfactoriamente',
            ])
    ...
    public function test_valida_request_registro()
    {
        $this->assertTrue(true);
        return [
            'El Nombre del Usuario es requerido para la autenticacion' => [
                'userNombre',
                null,
            ],
            'El mail es requerido para la autenticacion' => ['email', null],
     ...
     */
    public function test_valida_los_datos_del_registro_de_un_usuario(
        $campo,
        $valor
    ) {
        factory(Role::class)->create();
