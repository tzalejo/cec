...
class ComisionModuleTest extends TestCase
{
    ...
    public function test_obtener_una_comision()
    {
        $this->withoutMiddleware();
        factory(Curso::class)->create();
        $comision = factory(Comision::class)
            ->create()
            ->toArray();
    ...
    public function test_obtener_las_comisiones_inactivas_con_fechas_desde_hasta_invalidas()
    {
        ...
        factory(Comision::class)->create();
        $this->get(
            'api/comisiones/fecha_invalida/fecha_invalida'
    ...
    public function test_crear_una_comision()
    {
        ...
        $this->post('api/comisiones', $comision)->assertStatus(
    ...
    public function test_validacion_de_los_request_para_crear_un_comision()
    {
        ...
        return [
            ...
            'El campo Nombre tiene como maximo 150 caracteres' => [
                'comisionNombre',
                'El campo Nombre tiene como maximo 150 caracteresEl campo Nombre tiene como maximo 150 caracteresEl campo Nombre tiene como maximo 150 caracteresEl campo Nombre tiene como maximo 150 caracteres',
            ],
            'El campo Nombre requiere como minimo 3 caracteres' => [
                'comisionNombre',
                'ab',
            ],

            'Requiere el campo Horario' => ['comisionHorario', null],
            'El campo Horario tiene como maximo 50 caracteres' => [
                'comisionHorario',
                'El campo Nombre tiene como maximo 150 caracteresEl campo Nombre tiene como maximo 150 caracteresEl campo Nombre tiene como maximo 150 caracteres El campo Nombre tiene como maximo 150 caracteres',
            ],
            'El campo Horario requiere como minimo 3 caracteres' => [
                'comisionHorario',
                'ab',
            ],

            'Requiere el campo Fecha de Inicio' => ['comisionFI', null],
            'El valor del campo Fecha de Inicio es incorrecto' => [
                'comisionFI',
                'valor_invalido',
            ],

            'Requiere el campo Fecha de Fin' => ['comisionFF', null],
            'El valor del campo Fecha de Fin es incorrecto' => [
                'comisionFF',
                'valor_invalido',
            ],

            'Requiere el campo Curso ' => ['cursoId', null],
            'El valor del campo Curso es incorrecto' => [
                'cursoId',
                'valor_invalido',
            ],
        ];
    ...
    public function test_modificar_una_comision()
    {
        ...
        $this->put(
            sprintf('api/comisiones/%s', $comision['comisionId']),
            $comision
        )
    ...
    public function test_eliminar_una_comision()
    {
        ...
        // ->toArray();
        $this->delete('api/comisiones', $comision->toArray())->assertStatus(
            Response::HTTP_NO_CONTENT
        );
        $this->assertCount(0, Comision::all());
        $this->assertDeleted($comision);
    }
    ...
    public function test_eliminar_una_comision_con_alumnos_inscriptos()
    {
        ...
        $comision = factory(Comision::class)
            ->create()
            ->toArray();
        $estudiante = factory(Estudiante::class)
            ->create()
            ->toArray();
        factory(Matricula::class)
            ->create([
            ...
            ->toArray();
        $this->delete('api/comisiones', $comision)->assertStatus(
            Response::HTTP_FOUND
        );
        $this->assertCount(1, Comision::all());
    }
    ...
    public function test_eliminar_una_comision_que_no_existe()
    {
        $this->withoutMiddleware();
        factory(Curso::class)->create();
        $comisionNoExiste = factory(Comision::class)
            ->make()
            ->toArray();
        $this->delete('api/comisiones', $comisionNoExiste)->assertStatus(
            Response::HTTP_FOUND
        );
    }
